# From nothing to a working module-logger
...
By the end of this, somebody who has never seen module-logger should have it doing
something real.
...
Channel-aware Monolog logging for Magento 2 modules, with a var/log rotating file handler that respects DirectoryList.
